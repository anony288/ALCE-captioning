...
# output_dir
parser.add_argument('--downloaded_feats', default='data/pre_test_2014', help='downloaded feature directory')
parser.add_argument('--output_dir', default='data/cocobu_test2014', help='output feature files')
