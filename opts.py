...
def parse_opt():
    ...
    parser.add_argument('--input_concepts_json', type=str, default='/home/jijiayi/Data/annotations/visual_concepts.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--concept_size',type=int, default=1000,
                    help='size of the concepts')

    parser.add_argument('--concept_lambda', type=int, default=5,
                        help='the concepts lambda')
    # Reward
